...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_args_list = 8,                  /* args_list  */
  YYSYMBOL_get_words = 9,                  /* get_words  */
  YYSYMBOL_end = 10                        /* end  */
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* get_words: WORD  */
#line 30 "./parser/yacsh.y"
                {   //printf("Word: %s\n",$1);
                  if (cmd.argsNum == 0){
                      Command_create(&cmd, (yyvsp[0].word));
                  } else {
                      Command_addArgument(&cmd, (yyvsp[0].word));
                  }
                }
